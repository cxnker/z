...
local Window = redzlib:MakeWindow({
    Title = "Linux hub | Brookhaven RP 🏡",
    SubTitle = "by: こんにちはラウンドまたもっと1つ時間ンン, LinuxHubdev",
...
ImunesTab:AddToggle({
    Name = "Sumir Jogador",
    Description = "Ativa ou desativa o sumiço do jogador escolhido",
    Default = false,
    Callback = function(state)
        local Players = game:GetService("Players")
        ...
        if state then
            ...
            if player then
                ...
                StarterGui:SetCore("SendNotification", {
                    Title = "❌ Erro",
                    Text = "Digite o nome de um jogador válido!",
                    Duration = 3
                })
            end
        else
...
TrollTab:AddParagraph({ "Colaboração", "Thurr, Linux Hub, Gui" })
TrollTab:AddParagraph({ "Você está usando:", "Linux hub" })
...
TrollTab:AddSection({ "Rejoin & Informações" })
TrollTab:AddButton({
    Name = "Rejoin",
    Callback = function()
...
-- Variável compartilhada usando _G
...
if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
    TextChatService.TextChannels.RBXGeneral:SendAsync(
        "hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rServer: Expansão BY Linux hub"
    )
else 
    print("gojo chorou no banho F")
end
...
TrollTab:AddToggle({
    ...
    Default = false,
    Callback = function(value)
        -- Variáveis locais (dentro do toggle)
        local Players = game:GetService("Players")
        local RunService = game:GetService("RunService")
        
        -- Usar _G para persistir variáveis entre ativações/desativações
        ...
        if _G.ESPData.espEnabled then
            ...
            -- Limpar conexões antigas antes de criar novas
            ...
            -- Conexão para atualizar ESP continuamente
...
Tab:AddSection({"Utilitários"})

Tab:AddButton({
    Name = "Resetar Avatar",
    Description = "Volta ao avatar padrão do Roblox",
    Callback = function()
        local Players = game:GetService("Players")
        local StarterGui = game:GetService("StarterGui")
        local player = Players.LocalPlayer
